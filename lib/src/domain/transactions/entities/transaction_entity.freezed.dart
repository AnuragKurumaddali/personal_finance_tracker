...
class _$TransactionEntityImpl implements _TransactionEntity {
  ...
  @override
  String toString() {
    return 'TransactionEntity(id: $id, amount: $amount, category: $category, date: $date, note: $note, type: $type)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, amount, category, date, note, type);
...
abstract class _TransactionEntity implements TransactionEntity {
  const factory _TransactionEntity(
      ...
      final String? note,
      required final TransactionType type}) = _$TransactionEntityImpl;
