...
abstract class $CategoryEntityCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String name, bool isCustom});
}
...
class _$CategoryEntityImpl implements _CategoryEntity {
  ...
  @override
  String toString() {
    return 'CategoryEntity(id: $id, name: $name, isCustom: $isCustom)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, id, name, isCustom);
...
abstract class _CategoryEntity implements CategoryEntity {
  const factory _CategoryEntity(
      ...
      required final bool isCustom}) = _$CategoryEntityImpl;
